...
export function FloatingNotesPanel() {
  ...
  return (
    <FloatingNotesPanelInner
      projectCwd={openProject.cwd}
    ...
    (e: React.MouseEvent, handle: string) => {
      ...
      const onMove = (ev: MouseEvent) => {
        ...
        let newW = resizeStart.current.w,
          newH = resizeStart.current.h,
          newX = resizeStart.current.px,
          newY = resizeStart.current.py;
    ...
    >
      ...
      >
        ...
        <button
          ...
          className="flex items-center justify-center size-5 rounded text-muted-foreground/50 hover:text-foreground hover:bg-secondary/60 transition-colors"
      ...
      />
      <div
        className="absolute top-0 left-0 bottom-0 cursor-w-resize z-10"
        style={{ width: edge }}
        onMouseDown={(e) => onResizeStart(e, "w")}
      />
      <div
        className="absolute top-0 right-0 bottom-0 cursor-e-resize z-10"
        style={{ width: edge }}
